LANGUAGES = {
    ...
    "En": {
        ...
        "not_a_video_url_warning": "This isn't a video link (it may be a search results, channel, or playlist page).\n\nPlease enter a link to a single video.",
